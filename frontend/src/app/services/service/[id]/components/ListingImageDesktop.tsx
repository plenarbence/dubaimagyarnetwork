...
export default function ListingImageDesktop({
  images,
  activeImage,
  setActiveImage,
}: Props) {
  ...
  return (
    <div className="space-y-3">
      {/* MAIN IMAGE */}
      <div className="relative w-full h-[340px] bg-gray-50 rounded-lg flex items-center justify-center">
        <Image
        ...
        <div className="flex gap-2 overflow-x-auto pb-1">
          {images.map((url, idx) => (
            <button
              ...
              className={`relative h-24 aspect-3/4 rounded border shrink-0 ${
